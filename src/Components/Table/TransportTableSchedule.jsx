...
export default function Registrations({
  ...
  const Status = (data) => {
    return (
      <Badge
        value={data?.isPicked ? "PICKED" : "NOT_PICKED"}
        type={data?.isPicked ? "PICKED" : "NOT_PICKED"}
      />
    );
  };
    ...
    <div className="d-card">
      ...
      {data?.length > 0 ? (
        ...
        >
          ...
          <Column sortable field="phone_number" header="Phone Number"></Column>

          <Column sortable field="arrival_day" header="Arrival Day"></Column>
          <Column sortable field="arrival_time" header="Arrival Time"></Column>
          <Column
            sortable
        ...
        <div>
          <form>
            <div>
              ...
              <div className="mb-3">
                <div className="w-100">
                  <Button className="bg-info text-white" onClick={addLeaders}>
                    Submit
                  </Button>
                </div>
              </div>
