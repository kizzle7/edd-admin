...
import FoodLists from "../../Components/Table/FoodTable";
import "./index.css";
...
export const Food = ({ id, tab }) => {
  ...
  const getFams = () => {
    setLoad(true);
    axios
      .get(`${config.baseUrl}admin/food_schedules/all`, {
        headers: {
  ...
  return (
    <div>
      ...
      {!load && <FoodLists data={data} allData={allData} getFams={getFams} handleUpdateData={handleUpdateData} />}
