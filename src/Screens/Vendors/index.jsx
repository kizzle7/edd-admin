        ...
        <div class="row ">
          <div class="col-12 col-lg-12">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <span class="h2-primary">Orders </span>{" "}
              </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body order-height mb-0 pb-0">
                      <div class="row">
                        <div class="col-md-2">
                          <div class="d-flex justify-center align-items-center">
                            <img
                              ...
                              style={{ width: "50px" }}
                            />
                            <div className="pl-3 stat-label">Bag of Rice (20kg) </div>
                          </div>
                        </div>
                        <div className="stat-label col-md-2 d-flex justify-content align-items-center">
                          100,000.000
                        ...
                        <Button class="" text="View" className="mr-2"  style={{backgroundColor: '#2EC114', color: '#fff'}}  onClick={() => navigate.push("/view_vendor")}  />
                          <Button class="" text="Create"   style={{backgroundColor: '#171846', color: '#fff'}} />
                  ...
                  <div class="card mb-4">
                    <div class="card-body order-height mb-0 pb-0">
                      <div class="row">
                        <div class="col-md-2">
                          <div class="d-flex justify-center align-items-center">
                            <img
                              ...
                              style={{ width: "50px" }}
                            />
                            <div className="pl-3 stat-label">Bag of beans </div>
                          </div>
                        </div>
                        <div className="stat-label col-md-2 d-flex justify-content align-items-center">
                          100,000.000
                        ...
                        <div className="col-md-2 d-flex justify-content align-items-center mt-1">
                        <Button class="" text="Decline" className="mr-2"  style={{backgroundColor: '#2EC114', color: '#fff'}}   />
                          <Button class="" text="Accept"   style={{backgroundColor: '#171846', color: '#fff'}} />
                  ...
                  <div class="card mb-4">
                    <div class="card-body order-height mb-0 pb-0">
                      <div class="row">
                        ...
                        <div className="col-md-2 d-flex justify-content align-items-center mt-1">
                          <Button class="" text="View Store"   style={{backgroundColor: '#171846', color: '#fff'}} />
